...
**[https://ovelhaaa.github.io/Glitch-shifter-web/](https://ovelhaaa.github.io/Glitch-shifter-web/)**
...
1.  **Clone the repository**:
    ```bash
    git clone [https://github.com/ovelhaaa/Glitch-shifter-web.git](https://github.com/ovelhaaa/Glitch-shifter-web.git)
